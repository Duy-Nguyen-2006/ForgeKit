...
|---|---|---|---|
| Serena MCP | oraios/serena | ✅ Đã có (sửa tool names) | Symbol lookup, cross-file refactor, semantic code intelligence |
...
| Tool | Repository | Dùng cho | Pattern nguồn |
|---|---|---|---|
| code2prompt | mufeedvh/code2prompt | Fallback summary khi không có Serena, token-bounded output | ForgeKit code-map skill |
